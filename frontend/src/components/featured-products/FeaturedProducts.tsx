    ...
    <section className="mx-auto w-full max-w-[1455px] px-4 md:px-8 py-24">
      <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
        ...
        <div className="w-full lg:w-[28%] flex flex-col items-start self-start sticky top-24 min-h-[500px]">
          <div>
            <h2 className="text-[44px] font-bold leading-[1.1] text-black">
              {title}
            </h2>
          </div>
          
          <div className="mt-auto pt-32">
            <p className="text-[#666666] text-[16px] leading-relaxed mb-8 max-w-[300px]">
              {description}
            </p>
            <Link 
              href={cta.href}
              className="inline-flex h-[56px] px-10 items-center justify-center bg-black text-white text-[15px] font-bold rounded-md hover:bg-zinc-800 transition-colors"
            >
              {cta.label}
            </Link>
          </div>
